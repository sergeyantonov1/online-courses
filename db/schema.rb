...
ActiveRecord::Schema.define(version: 20180516173728) do
  ...
  create_table "teachers", force: :cascade do |t|
    ...
    t.index ["invited_by_type", "invited_by_id"], name: "index_teachers_on_invited_by_type_and_invited_by_id"
